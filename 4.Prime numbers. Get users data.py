...
####################           Get users data    ##########################
'''
Тобі приходять дані про користувачів твоєї компанії. Але ці дані не впорядковані і, щоб полегшити роботу своїх колег,
тобі треба їх структурувати. Було б не погано мати таку структуру даних, в якій ти можеш отримати інформацію про
користувача, звертаючись за id цього користувача.

Напиши функцію get_users_data, яка отримує список з даними користувачів.
Список з даними користувачів це список, який складається з кортежів, кожний з яких складається з
чотирьох значень: id, username, email, password конкретного користувача.

Функція повинна повертати словник, в якому ключі це id користувача, а значення цих ключів - також словник з
рештою даних: username, email, password.
